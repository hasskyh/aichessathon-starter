...
#
# This variant swaps the endgame branch's evaluation for plain material+mobility
# (evaluate(), same function invictus_v5_material uses) instead of the trained
# endgame net, keeping the main-game NNUE and all the regime-switching machinery
# otherwise unchanged -- a direct test of "does the trained endgame net actually
# help over material eval," isolated from the main-game evaluation question.
